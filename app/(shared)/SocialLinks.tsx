...
const SocialLinks = ({ isDark = false, className }: SocialLinksProps) => {
  return (
    <div className={`${className} flex justify-between items-center gap-7`}>
      ...
      <a href="https://facebook.com" target="_blank" rel="noreferer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="facebook"
          src={Facebook}
      ...
      <a href="https://google.com" target="_blank" rel="noreferer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="google"
          src={Google}
      ...
      <a href="https://discord.com" target="_blank" rel="noreferer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="discord"
          src={Discord}
